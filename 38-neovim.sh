# Neovim
# ======
# Configuration and helpers for the neovim, my main text editor
...
CopyFile /home/davi/.config/nvim/lua/plugins/indent.lua '' davi davi
CopyFile /home/davi/.config/nvim/lua/plugins/lsp.lua '' davi davi
CopyFile /home/davi/.config/nvim/lua/plugins/map.lua '' davi davi
CopyFile /home/davi/.config/nvim/lua/plugins/nvim-obsidian.lua '' davi davi
CopyFile /home/davi/.config/nvim/lua/plugins/picker.lua '' davi davi
...
CopyFile /home/davi/.config/nvim/lua/plugins/trailspace.lua '' davi davi
...
# Installed to remove warnings from the nvim LSP
...
# Installed initially to be able to install LSP servers for nvim automatically
# with the use of an nvim extension (mason)
AddPackage npm # JavaScript package manager

# Installed as a dependency of nvim plugins (more specifically, Telescope)
...
# Optional dependency of some nvim plugins/configurations. I think that this are
# needed for the LSP servers of these specific languages
AddPackage --foreign clangd-bin # Clangd Language Server
AddPackage --foreign hyprls     # A LSP server for Hyprland config files

# These are the configurations recipes from the nvim-lspconfig plugin which I
# downloaded locally and edited so I do not have to rely on another plugin and
# it is easier to edit the configuration
