# This file contain the software that is strongly recommended to have running for a smooth Hyprland experience.
# https://wiki.hyprland.org/Useful-Utilities/Must-have/

# Hyperland itself
AddPackage hyprland # a highly customizable dynamic tiling Wayland compositor

# The default and my primary terminal emulator
AddPackage kitty # A modern, hackable, featureful, OpenGL-based terminal emulator

# Notification deamon
AddPackage swaync # A simple GTK based notification daemon for Sway
# I chose it over other options because of its high customization capacity

# pipiwire and related packages recomended by the Arch Wiki
