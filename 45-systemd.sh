# Contain systemd services

# This is for changing the image and text of the minegrub theme on each boot
CopyFile /etc/systemd/system/minegrub-update.service
# Remember to enable it `systemctl enable minegrub-update.service`
