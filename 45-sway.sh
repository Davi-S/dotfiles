...
#
# Sway-related packages and configuration. Sway is only used as a fallback compositor
# when Hyprland is unavailable.

# Only sway-specific thing belong here. Features used "also" by Sways are kept in other modules.
