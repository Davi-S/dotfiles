...
local user_opts = {
    ...
    hidetimeout = 1500,          -- duration in ms until the OSC hides if no mouse movement. enforced non-negative for the user, but internally negative is 'always-on'.
    fadeduration = 250,          -- duration of fade out in ms, 0 = no fade
    minmousemove = 1,            -- minimum amount of pixels the mouse has to move between ticks to make the OSC show up
    ...
    showjump = true,             -- show "jump forward/backward 5 seconds" buttons shift+left-click to step 1 frame and right-click to jump 1 minute
    ...
    jumpmode = 'exact',          -- seek mode for jump buttons. e.g. 'exact', 'relative+keyframes', etc.
...
local osc_styles = {
    ...
    SeekbarFg = '{\\blur1\\bord1\\1c&HECC774&}',
    ...
    elementHighlight = '{\\blur1\\bord1\\1c&HECC774&}',
}
...
-- Disabled windows controls permanently
